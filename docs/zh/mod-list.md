...
标识: ✨- `值得深究`  | ⚠️- `不稳定` ❓ - `试验内容` |📦- `用来标识以依赖关联`

**为了通用性，我们选择了 [Iris](https://github.com/IrisShaders/Iris), 但如你所知 [Canvas](https://github.com/vram-guild/canvas) 在独显下有更高的性能和更好的光影质量。
如果您不需要 Optifine 光影包，请看看 Canvas 的优质光影作品！**

*标识符 象征简写名称，点击可以跳转到模组页面!*
